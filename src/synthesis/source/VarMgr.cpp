...
void VarMgr::print_name_to_variable() const {
  for (const auto& name_to_var: name_to_variable_) std::cout << "Var name: " << name_to_var.first << ". Variable: " << name_to_var.second << std::endl;
}

void VarMgr::print_index_to_name() const {
  for (const auto& index_name: index_to_name_) std::cout << "ID: " << index_name.first << ". Var name: " << index_name.second << std::endl;
}
...
std::vector<int> VarMgr::make_eval_vector(
    std::size_t automaton_id, const std::vector<int>& state_vector) const {
      // std::cout << "TOTAL NON STATE VARIABLES COUNT = " << name_to_variable_.size() << std::endl;
      // std::cout << "TOTAL STATE VARIABLES COUNT = " << total_state_variable_count() << std::endl;
...
std::vector<std::string> VarMgr::variable_labels() const {
  ...
  //std::cout << "total variable count is: " << total_variable_count() << std::endl;
  //std::cout << name_to_variable_.size() << " are named variables " << std::endl;
  //std::cout << total_state_variable_count() << " are state variables " << std::endl;
  //std::cout << "true state variables are: ";
  //int s_vars = 0;
  //for (auto v : state_variables_) {
  //  s_vars += v.size();
  //}
  //std::cout << s_vars << std::endl;

  //std::cout << "labels construction..." << std::endl;
  for (const auto& index_and_name : index_to_name_) {
    //std::cout << index_and_name.first << " " << index_and_name.second << std::endl;
    //std::cout << "performing assignment..." << std::endl;
    labels[index_and_name.first] = index_and_name.second;
    //std::cout << "moving to next..." << std::endl;
  }
  //std::cout << "labels constructed..." << std::endl;

  //std::cout << "constructing state vars..." << std::endl;
  ...
  //std::cout << "constructing state vars... done" << std::endl;
