...
class VarMgr {
    ...
    friend class CompositionalBeSynthesizer;
    friend class BestEffortPlanner;
  ...
  /**
   * @brief Prints the map from indexes to names in the standard output
   * 
   */
  void print_index_to_name() const;

  /**
   * @brief Prints the map from names to vars in the standard output
   * 
   */
  void print_name_to_variable() const;
